...
handleChatSlide = () =>{
	let chatElements = Array.from(document.querySelectorAll('.chat-window'))
	for (let element of chatElements) {
	  element.classList.add('chat-slide')
	}
}

handleUserList =() =>{
	let chatElements = Array.from(document.querySelectorAll('.chat-window.chat-slide'))
	for (let element of chatElements) {
	  element.classList.remove('chat-slide')
	}
}
						...
						<div className="col-xl-12">
							<div className="chat-window">
								...
								<div className="chat-cont-left">
									...
									<div className="chat-users-list">
										<div className="chat-scroll">
											<a href="#0" className="media" onClick={()=>this.handleChatSlide()}>
											...
											<a href="#0" className="media read-chat active" onClick={()=>this.handleChatSlide()}>
												<div className="media-img-wrap">
										...
										<img src={IMG02} alt="User" className="avatar-img rounded-circle" />
											...
											<a href="#0" className="media read-chat" onClick={()=>this.handleChatSlide()}>
												<div className="media-img-wrap">
													<div className="avatar avatar-online">
								...
								<div className="chat-cont-right">
									<div className="chat-header">
										<a id="back_user_list" href="#0" className="back-user-list" onClick={()=>this.handleUserList()}>
